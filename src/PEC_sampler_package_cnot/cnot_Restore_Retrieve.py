...
def save_fidelity_figures(fig_trial, fig_dist, n_trials: int,
    ...
    例如：
        output_graph/20251117-163210_50/Fidelity_trial.png
    """
    ...
    # 3. 路徑
    path_trial = save_dir / "Fidelity_trial.png"
    path_dist  = save_dir / "Fidelity_distribution.png"

    # 4. 存檔
    fig_trial.savefig(path_trial, dpi=300, bbox_inches="tight")
    fig_dist.savefig(path_dist, dpi=300, bbox_inches="tight")

    print(f"[SAVE] Fidelity_trial → {path_trial}")
    print(f"[SAVE] Fidelity_distribution → {path_dist}")
